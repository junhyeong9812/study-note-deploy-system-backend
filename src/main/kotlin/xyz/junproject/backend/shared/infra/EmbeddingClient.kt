...
import xyz.junproject.backend.search.usecase.QueryEncoder

import xyz.junproject.backend.indexing.usecase.TextEncoder
...
@Component
class EmbeddingClient : TextEncoder, QueryEncoder {
    ...
    override fun embed(texts: List<String>): List<List<Double>> = call(batchClient, texts)
