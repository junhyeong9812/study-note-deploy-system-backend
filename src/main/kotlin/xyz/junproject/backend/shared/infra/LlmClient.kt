...
import xyz.junproject.backend.search.usecase.QueryRewritePort
...
@Component
class LlmClient(private val requestLog: RequestLog) : QueryRewritePort {
    ...
    override fun rewrite(requestId: String, query: String): RewriteOutcome = try {
