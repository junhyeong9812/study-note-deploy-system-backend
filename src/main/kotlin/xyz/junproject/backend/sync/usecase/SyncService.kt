...
import xyz.junproject.backend.content.usecase.TreeService


import org.springframework.stereotype.Service
import xyz.junproject.backend.shared.infra.RequestLog
import xyz.junproject.backend.indexing.usecase.IndexingService
import java.io.File
...
@Service
class SyncService(
    private val git: SourceControlPort,
    ...
    private fun runPipeline(requestId: String, prevSha: String?, full: Boolean = false) {
        ...
        try {
            ...
            } catch (_: ShaUnresolvableException) {
